...
btn_01 = Button(root, text = 'n!', width = 3, height = 1)
...
btn_02 = Button(root, text = 'sqrt', width = 3, height = 1)
btn_02.grid(row = 2, column = 3, pady = 5)
btn_sqrt = Button(root, text = '^', width = 3, height = 1)
btn_sqrt.grid(row = 2, column = 4, padx = 5, pady = 5)
...
btn_05 = Button(root, text = ')', width = 3, height = 1)
